...
@generated function mytryparsenext_internal(::Type{T}, str, pos::Int, len::Int, df::DateFormat) where {T <: Dates.TimeType}
...
@generated function mytryparsenext_core(str, pos::Int, len::Int, df::DateFormat)
...
@inline function Dates.tryparsenext_base10(str::AbstractVector{UInt8}, i::Int, len::Int, min_width::Int=1, max_width::Int=0)
    i > len && return nothing
